...
gcs_agent = Agent(
    ...
    instruction="""
                You are a helpful agent that specializes in answering questions and providing detailed information related to Google Cloud Storage.
                ...
                If user says to scan a vulnerability in their Cloud Storage project, call the scan_vulnerabilities.
