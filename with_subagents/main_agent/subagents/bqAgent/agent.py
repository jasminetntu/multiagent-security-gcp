...
bq_agent = Agent(
    ...
    instruction="""
                You are a helpful agent that specializes in answering questions and providing detailed information related to Google BigQuery.
